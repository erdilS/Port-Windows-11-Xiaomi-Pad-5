...
<style>
  ...
  .snow__flake {
    ...
    background: white;
    border-radius: 50%;
    animation: snowflakes-fall 10s linear infinite, snowflakes-shake 3s infinite;
    opacity: 0.8;
  }
...
<div class="snow">
  <div class="snow__flake" style="width: 10px; height: 10px; left: 10%; animation-duration: 9s;"></div>
  <div class="snow__flake" style="width: 15px; height: 15px; left: 20%; animation-duration: 8s;"></div>
  <div class="snow__flake" style="width: 12px; height: 12px; left: 30%; animation-duration: 10s;"></div>
  <div class="snow__flake" style="width: 18px; height: 18px; left: 40%; animation-duration: 9s;"></div>
  <div class="snow__flake" style="width: 20px; height: 20px; left: 50%; animation-duration: 8s;"></div>
  <div class="snow__flake" style="width: 17px; height: 17px; left: 60%; animation-duration: 10s;"></div>
  <div class="snow__flake" style="width: 25px; height: 25px; left: 70%; animation-duration: 9s;"></div>
  <div class="snow__flake" style="width: 22px; height: 22px; left: 80%; animation-duration: 8s;"></div>
  <div class="snow__flake" style="width: 15px; height: 15px; left: 90%; animation-duration: 10s;"></div>
</div>
