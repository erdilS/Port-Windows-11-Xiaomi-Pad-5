...
## Мова
[```Русский```](/guide/Russian/README-RU.md) | [```English```](/README.md) | **```Український```** | [```한국어```](/guide/Korean/README-KO.md)

> [!Note]
> - Помер друг всіх розробників, перекладачів і тд - Амріт(ArKT). Давайте зробимо так щоб йому жилося на тому світі дуже і дуже добре. Ми розуміємо, можливо ви його не знаєте, але вс> ж, зробіть це. Спочивай у мирі, Амріт....
