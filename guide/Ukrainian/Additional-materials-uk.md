...
- Запустіть [USB Host Control](https://github.com/n00b69/usbhostmode) щоб увімкнути/вимкнути режим USB-хоста та підтвердити, що ви бажаєте вимкнути/увімкнути режим USB-хоста
