...
> [!CAUTION]
> Ця інструкція **не призначена для оновлення драйверів до версії 2601.19**.  
> Використання її для цієї версії може призвести до помилок або нестабільної роботи системи.
