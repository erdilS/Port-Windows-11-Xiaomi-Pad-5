...
Execute [USB Host Control](https://github.com/erdilS/Port-Windows-11-Xiaomi-Pad-5/releases/download/USBHost/USB.Host.Mode.Control.V4.0.vbs) para ativar/desativar o modo USB host, e então reinicie o tablet.
