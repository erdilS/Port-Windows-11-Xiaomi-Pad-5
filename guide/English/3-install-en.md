...
- [```DriveLetterAssigner_NABU script```](https://github.com/Misha803/My-Scripts/releases/tag/DriveLetterAssigner_NABU)
...
> **Just run  [```DriveLetterAssigner_NABU script```](https://github.com/Misha803/My-Scripts/releases/tag/DriveLetterAssigner_NABU) and press `Y` on you your keyboard**
...
> If an error occurs when copying boot files, just run [**```DriveLetterAssigner_NABU script```**](https://github.com/Misha803/My-Scripts/releases/tag/DriveLetterAssigner_NABU) again, it will assign letter U to ESPNABU, then run the following command again replacing Y with U
```cmd
