...
> [!NOTE]
> On the first Windows boot, it will not see any Wi-Fi networks, then just restart it by holding down the power button, and after reboot when you try connect to yuor network and you see "ice cream" click "try again" 7 times
