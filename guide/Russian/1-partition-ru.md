...
### Способ 2: ручная разметка (используйте его только в том случае, если вы знаете, что делаете)
...
>
> Если нет, перезагрузите устройство в режим восстановления и выполните сброс к заводским настройкам
```cmd
adb reboot recovery
```
