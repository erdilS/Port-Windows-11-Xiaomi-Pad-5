...
- Вот визуальный метод установки и проверки правильной установки Won-Deployer:

<img align="left" src="https://github.com/ArKT-7/won-deployer/blob/main/assets/tool-insatllation1.gif" width="720" alt="Руководство по установке">
