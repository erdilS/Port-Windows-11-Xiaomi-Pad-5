...
> [!CAUTION]
> ❗️Эта инструкция **не предназначена для обновления драйверов до версии 2601.19**.❗️  
> Использование её для этой версии **может привести к ошибкам или неработоспособности системы**.
