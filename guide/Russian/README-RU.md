...
> [!WARNING]
> Если вы боитесь модифицировать планшет, изменять его таблицу разделов или получить кирпич, самое время прекратить чтение. Однако установка Windows достачно проста, так что даже новички смогут сделать это: просто внимательно следуйте каждой инструкции.
...
- [**`🔧Исправление GPT для безопасного использования Windows 24H2`**](fix-gpt-ru.md)
