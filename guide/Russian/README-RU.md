...
## ⚠️ Предупреждение
> [!NOTE]
> - Скончался друг всех разработчиков, переводчиков и тд - Амрит(ArKT). Давайте сделаем так чтобы ему жилось на том свете очень и очень хорошо. Мы понимаем, возможно вы его не знаете, но все же, сделайте это. Покойся с миром, Амрит....
